...
contextBridge.exposeInMainWorld("questUtils", {
  ...
  getQuestById: (category, id) =>
    ipcRenderer.invoke("getQuestById", category, id),
  ...
  deleteQuest: (category, data) =>
    ipcRenderer.invoke("deleteQuest", category, data),
  postNotification: (questid, category, data) =>
    ipcRenderer.invoke("postNotification", questid, category, data),
  putNotification: (id, data) =>
    ipcRenderer.invoke("putNotification", id, data),
  deleteNotification: (id) => ipcRenderer.invoke("deleteNotification", id),
  getNotificationsForQuest: (id, category) =>
    ipcRenderer.invoke("getNotificationsForQuest", id, category),
...
contextBridge.exposeInMainWorld("keeperUtils", {
  ...
  generateScavenges: (category) =>
    ipcRenderer.invoke("generateScavenges", category),
...
contextBridge.exposeInMainWorld("localeUtils", {
  getQuestCategoryData: (category) =>
    ipcRenderer.invoke("getQuestCategoryData", category),
  postQuestCategoryData: (category, data) =>
    ipcRenderer.invoke("postQuestCategoryData", category, data),
  putQuestCategoryData: (category, id, data) =>
    ipcRenderer.invoke("putQuestCategoryData", category, id, data),
  deleteQuestCategoryData: (category, id) =>
    ipcRenderer.invoke("deleteQuestCategoryData", category, id),
  levelKeeper: (category, skill, upOrDown) =>
    ipcRenderer.invoke("levelKeeper", category, skill, upOrDown),
});
...
contextBridge.exposeInMainWorld("generic", {
  ...
  saveMaterialConfig: (config) =>
    ipcRenderer.invoke("saveMaterialConfig", config),

  exportData: (config) => ipcRenderer.invoke("exportData", config),
  importData: (config) => ipcRenderer.invoke("importData", config),

  getLocaleData: (category) => ipcRenderer.invoke("getLocaleData", category),
  getLocaleKeeperData: (category) =>
    ipcRenderer.invoke("getLocaleKeeperData", category),
